...
public class SubscriptionServiceTest {
    ...
    public void testGetSubscriptionByJobId() {
        ...
        SubscriptionDto expectedDto = SubscriptionDto.builder().filePath(subscription.getFilePath()).email(subscription.getEmail()).jobId(subscription.getJobId()).active(subscription.isActive()).build();
    ...
    public void testGetAllSubscriptions() {
        ...
        SubscriptionDto dto1 = SubscriptionDto.builder().filePath(subscription1.getFilePath()).email(subscription1.getEmail()).jobId(subscription1.getJobId()).active(subscription1.isActive()).build();

        SubscriptionDto dto2 = SubscriptionDto.builder().filePath(subscription2.getFilePath()).email(subscription2.getEmail()).jobId(subscription2.getJobId()).active(subscription2.isActive()).build();
    ...
    public void testGetSubscriptionStatusByJobId_NieistniejącaSubskrypcja() {
        ...
        assertThrows(SubscriptionNotFoundException.class, () -> subscriptionService.getSubscriptionStatusByJobId(jobId), "Oczekiwano zgłoszenia SubscriptionNotFoundException dla nieistniejącej subskrypcji");
    ...
    public void testGetSubscriptionStatusByJobId_NonExistingSubscription() {
        ...
        assertThrows(SubscriptionNotFoundException.class, () -> subscriptionService.getSubscriptionStatusByJobId(jobId), "Expected SubscriptionNotFoundException to be thrown for non-existing subscription");
    ...
    public void testCreateSubscriptionWithBlankFilePath() {
        CreateSubscriptionCommand command = CreateSubscriptionCommand.builder().filePath("").email("test@example.com").build();
    ...
    public void testCreateSubscriptionWithBlankEmail() {
        CreateSubscriptionCommand command = CreateSubscriptionCommand.builder().filePath("testFilePath").email("").build();
    ...
    public void testCreateSubscriptionWithInvalidEmail() {
        CreateSubscriptionCommand command = CreateSubscriptionCommand.builder().filePath("testFilePath").email("invalid-email").build();
